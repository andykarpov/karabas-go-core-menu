...
xst -ifn xst.scr
move pllx5_2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pllx5_2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pllx5_2_exdes.ucf pllx5_2_exdes

echo 'Running map'
map -timing -pr b pllx5_2_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pllx5_2_exdes -w routed.ncd routed.v
cd ..
